package com.zhuyan.smsinterception.receiver;
...
import com.zhuyan.smsinterception.ui.listadapter.MainListAdapter;
import com.zhuyan.smsinterception.util.SettingShares;
import com.zhuyan.smsinterception.util.TimeConverter;
import com.zhuyan.smsinterception.util.slipt.BayesClassifier;
import com.zhuyan.smsinterception.util.slipt.SpecialClassify;
...
//		System.out.println("ok?:"+ok+"    "+(ok && isTimeOK(sharedPreferences)));
		if(ok && isTimeOK(sharedPreferences)){
			com.zhuyan.smsinterception.entity.SMS mySms = 
					new com.zhuyan.smsinterception.entity.SMS(body,num);
